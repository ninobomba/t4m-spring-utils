...
class ApplicationXSSAttackEventTest {

	@Test
	void constructor_shouldSetSourceAndMessage ( ) {
		Object source = new Object ( );
		String message = "XSS Attack detected";
		ApplicationXSSAttackEvent event = new ApplicationXSSAttackEvent ( source, message );
	...
	void constructorWithClock_shouldSetSourceClockAndMessage ( ) {
		Object source = new Object ( );
		String message = "XSS Attack detected with clock";
		Clock clock = Clock.fixed ( Instant.now ( ), ZoneId.systemDefault ( ) );
		ApplicationXSSAttackEvent event = new ApplicationXSSAttackEvent ( source, clock, message );
